...
var DtsGenerator = (function () {
    function DtsGenerator(resolver, convertor, namespaceName) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        map = this.convertor.buildSchemaMergedMap(this.resolver.getAllRegisteredSchema(), typeMarker, this.namespaceName);
        ...
        if (content.properties) {
            try {
                for (var _b = tslib_1.__values(Object.keys(content.properties)), _c = _b.next(); !_c.done; _c = _b.next()) {
                    ...
                    var schema = this.normalizeContent(baseSchema, '/properties/' + propertyName);
