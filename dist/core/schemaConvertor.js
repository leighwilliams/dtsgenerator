...
var SchemaConvertor = (function () {
    function SchemaConvertor(processor, convertor) {
    ...
    SchemaConvertor.prototype.buildSchemaMergedMap = function (schemas, typeMarker, namespaceName) {
            ...
            for (var paths_1 = tslib_1.__values(paths), paths_1_1 = paths_1.next(); !paths_1_1.done; paths_1_1 = paths_1.next()) {
                ...
                if (namespaceName != null) {
                    ...
                    if (namespaceName.length > 0) {
                        path.unshift.apply(path, tslib_1.__spread(namespaceName.split('/')));
                    }
                }
